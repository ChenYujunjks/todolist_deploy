...
export const metadata = {
  ...
  description: "Browse all personal trading notes.",
};
    ...
    <div className="mx-auto w-full max-w-5xl py-6 md:py-10">
      <section className="mb-8">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
          All trading notes are collected here. Choose a note below to open its
          page.
        </p>
      </section>

      <section aria-label="Note folders" className="grid gap-3">
        {notes.map((note) => (
          <Link
            key={note.href}
            href={note.href}
