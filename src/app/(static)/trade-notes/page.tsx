    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100 px-6 py-10">
      <div className="mx-auto max-w-4xl space-y-8">
        <header className="space-y-3">
          <p className="text-sm text-neutral-400">Trading Notes</p>
        ...
        <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-6 space-y-4">
          ...
          <div className="space-y-2 text-neutral-300">
            <p>
              <strong className="text-neutral-100">4h / 日线：</strong>
              代表更大资金、波段资金、机构风险敞口。
            </p>
            <p>
              <strong className="text-neutral-100">1h：</strong>
              代表主动交易者和短线资金。
            </p>
            <p>
              <strong className="text-neutral-100">15m：</strong>
              更多是情绪、噪音和追单资金。
            </p>
          </div>
          ...
          <p className="rounded-xl bg-neutral-800 p-4 text-neutral-200">
        ...
        <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-6 space-y-4">
          ...
          <div className="space-y-2 text-neutral-300">
            <p>
              <strong className="text-neutral-100">EMA20：</strong>
              短期参与者的平均成本。
            </p>
            <p>
              <strong className="text-neutral-100">EMA50：</strong>
              中期参与者的平均成本。
            </p>
            <p>
              <strong className="text-neutral-100">EMA200：</strong>
              更长期资金的成本参考。
            </p>
          </div>
        ...
        <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-6 space-y-4">
          ...
          <div className="space-y-2 text-neutral-300">
            <p>
              <strong className="text-neutral-100">天地针：</strong>
              价格冲高或下探后无法收住，说明该区域存在强烈反向力量。
            </p>
            <p>
              <strong className="text-neutral-100">假突破：</strong>
              价格突破关键位置后无法延续，容易形成反向陷阱。
            </p>
            <p>
              <strong className="text-neutral-100">冲高不收：</strong>
        ...
        <section className="rounded-2xl border border-emerald-800 bg-emerald-950/40 p-6 space-y-4">
